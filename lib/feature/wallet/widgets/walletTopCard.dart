    ...
    return GetBuilder<WalletController>(builder: (walletController){
      ...
      return Container(height: Dimensions.WALLET_TOP_CARD_HEIGHT,
        ...
        child: Stack(alignment: AlignmentDirectional.bottomEnd,children: [
          Image.asset(Images.walletBackground,height: Dimensions.WALLET_TOP_CARD_HEIGHT*0.6,),
          Padding(padding: const EdgeInsets.all(Dimensions.PADDING_SIZE_LARGE),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
              ...
              Directionality(
                ...
                child: Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.PADDING_SIZE_SMALL),
