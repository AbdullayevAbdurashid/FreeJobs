...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    Get.find<CheckOutController>()
        .updateDigitalPaymentOption(PaymentMethodName.COS, shouldUpdate: false);
        ...
        appBar: CustomAppBar(
            ...
            onBackPressed: () {
              if (widget.pageState == 'payment' ||
                  Get.find<CheckOutController>().currentPage ==
                      PageState.payment) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GetBuilder<CheckOutController>(builder: (controller) {
                          print(
                              "current_page_initial:${controller.currentPage}");
                                      ...
                                      if (controller.selectedPaymentMethod !=
                                        ...
                                        if (!Get.find<ScheduleController>()
                                          ...
                                          if (controller.currentPage ==
                                            ...
                                            print(
                                                "address_model_id:${addressModel.id.toString()}");
                                            if (controller
                                                        .selectedPaymentMethod ==
                                                    PaymentMethodName.COS ||
                                                controller
  ...
  Future<bool> _exitApp() async {
    ...
    if (widget.pageState == 'payment' ||
        Get.find<CheckOutController>().currentPage == PageState.payment) {
      print("inside_here_true");
      Get.find<CheckOutController>().updateDigitalPaymentOption(
          PaymentMethodName.COS,
          shouldUpdate: false);
