...
class _PaymentPageState extends State<PaymentPage> {
  ...
  List<PaymentMethodButton> listOfButton = [
    ...
    // Add this condition for "kafolatli"
    PaymentMethodButton(
      title: "kafolatli".tr,
      description:
          "Kafolatli tolov", // Replace "kafolatli" with the actual translated text for the button
      paymentMethodName: PaymentMethodName.kafolatli,
      assetName: Images
          .walletMenu, // Replace "Images.kafolatliIcon" with the actual asset for the button icon
    ),
  ];
      ...
      child: Column(
        children: [
          ...
          (paymentMethodAvailable)
              ...
              : Padding(
                  padding: const EdgeInsets.only(
                      top: Dimensions.paddingSizeLarge * 2),
                  child: Text(
