...
class PaymentMethod extends StatefulWidget {
  ...
  const PaymentMethod({Key? key, this.postId, this.providerId})
      : super(key: key);
      ...
      return Column(
        children: [
          ...
          Text("payment_method".tr,
              style:
                  ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  itemBuilder: (context, index) {
                    return GetBuilder<CheckOutController>(
                      ...
                      return GestureDetector(
                        onTap: () =>
                            controller.updateSelectedDigitalPaymentIndex(index),
                        child: Stack(children: [
                          DigitalPayment(
                            paymentGateway: paymentGateways[index],
                            addressId: Get.find<LocationController>()
                                .selectedAddress
                                ?.id
                                .toString(),
