...
import 'package:demandium/feature/checkout/model/post_details_model.dart';
...
enum PaymentMethodName { digitalPayment, cos, walletMoney, none, kafolatli }
...
class CheckOutController extends GetxController implements GetxService {
  ...
  void updateKafolatliPaymentOption({bool shouldUpdate = true}) {
    selectedPaymentMethod = PaymentMethodName.kafolatli;
    if (shouldUpdate) {
      update();
    }
  }
  ...
  void updateSelectedDigitalPaymentIndex(int index,
      {bool shouldUpdate = true}) {
