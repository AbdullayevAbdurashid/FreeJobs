...
class AppConstants {
  static const String APP_NAME = 'TopUsta';
  static const String APP_VERSION = '1.3';
  static const String BASE_URL = 'https://topusta.markoola.uz';
  ...
  static const String TRENDING_SERVICE_URI =
      '/api/v1/customer/service/trending';
  static const String RECENTLY_VIEWED_SERVICE_URI =
      '/api/v1/customer/service/recently-viewed';
  static const String RECOMMENDED_SERVICE_URI =
      '/api/v1/customer/service/recommended';
  static const String RECOMMENDED_SEARCH_URI =
      '/api/v1/customer/service/search/recommended';
  static const String OFFER_LIST_URI = '/api/v1/customer/service/offers';
  static const String SERVICE_BASED_ON_SUB_CATEGORY =
      '/api/v1/customer/service/sub-category/';
  static const String ITEMS_BASED_ON_CAMPAIGN_ID =
      '/api/v1/customer/campaign/data/items?campaign_id=';
  static const String SERVICE_DETAILS_URI = '/api/v1/customer/service/detail';
  static const String GET_SERVICE_REVIEW_LIST =
      '/api/v1/customer/service/review/';
  static const String SUB_CATEGORY_URI =
  ...
  static const String GET_CART_LIST =
  ...
  static const String UPDATE_CART_PROVIDER =
  ...
  static const String SUGGESTED_SEARCH_URI =
      '/api/v1/customer/recently-searched-keywords';
  static const String REMOVE_SUGGESTED_SEARCH_URI =
      '/api/v1/customer/remove-searched-keywords';
  static const String CAMPAIGN_URI =
      '/api/v1/customer/campaign?limit=10&offset=1';
  static const String DISTANCE_MATRIX_URI =
      '/api/v1/customer/config/distance-api';
  ...
  static const String GET_CHANNEL_LIST =
      '/api/v1/customer/chat/channel-list?limit=10&';
  ...
  static const String SUBMIT_NEW_SERVICE_REQUEST =
      '/api/v1/customer/service/request/make';
  static const String GET_SUGGESTED_SERVICE_LIST =
      '/api/v1/customer/service/request/list';
  static const String CONVERT_LOYALTY_POINT_TO_WALLET =
      '/api/v1/customer/loyalty-point/wallet-transfer';
  static const String LOYALTY_POINT_TRANSACTION_DATA =
      '/api/v1/customer/loyalty-point-transaction';
  static const String WALLET_TRANSACTION_DATA =
      '/api/v1/customer/wallet-transaction';
  static const String GET_PROVIDER_LIST =
      '/api/v1/customer/provider/list?limit=10&offset=';
  static const String GET_PROVIDER_DETAILS =
      '/api/v1/customer/provider/details';
  static const String GET_PROVIDER_BASED_ON_SUBCATEGORY =
      '/api/v1/customer/provider/list-by-sub-category';
  static const String GET_FEATHERED_SERVICE_CATEGORY =
